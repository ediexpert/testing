...
<div class="container">
   ...
   <form class="form-horizontal" method="post" action="post.php" name="wordcount"  enctype="multipart/form-data" role="form">   
...
<div style="color:green;text-align:center;" ><h4> <?php  echo $_GET["success"]; ?></h4></div>
  ...
  <div class="form-group">
		  ...
		  <div class="col-sm-10">   
		   <input type="text" name="post_title" class="form-control" placeholder="Title" id="email">
		  </div>
		 </div>
		 <div class="form-group">
			<label for="username" class="col-sm-2"></label>
		  <div class="col-sm-10">   
		   <div class="btn btn-default image-preview-input">
                        ...
                        <input type="file" id="filUpload" onchange="showimagepreview(this)" accept="image/png, image/jpeg, image/gif" name="post_image" style="height:100%;width:100%;" required=""/> <!-- rename it -->
                    </div>
                    <?php 
						$sql2 = mysql_query("SELECT * FROM User_Registration");
						$newrow = mysql_fetch_array($sql2);
						$uid = $newrow["id"];
                    	$sql = mysql_query("SELECT * FROM ManagePost WHERE userid = '$uid' order by id desc");
		 ...
		 <div class="form-group">
			...
			<label for="username" class="col-sm-2"></label>
		  <div class="col-sm-10">   
		   <textarea type="text" name="post_description" class="form-control desheight" placeholder="Description" id="email"></textarea>
		 ...
		 <div class="form-group">
			<label for="username" class="col-sm-2"></label>
		  <div class="col-sm-10">   
		   <input type="text" name="post_keywords" class="form-control" placeholder="Keyword" id="email">
		  </div>
		 </div>
		  <div class="form-group">
