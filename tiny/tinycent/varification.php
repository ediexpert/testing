...
<div class="col-md-6">
  <p class="varification">
 An validation mail has been sent to your Registered Email Address, Please verify.<br>	<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	Done with verification ?

  </p>
<br>
<div class="col-md-12 center-block">
<div class="col-md-6"> 
<div id="submitForm"><form action="signin.php">
    <input type="submit" value="" name="signin" ></form>
</div>
</div>
</div>
