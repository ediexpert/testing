		...
		<div class="col-md-10">
			<div class="row">
				...
				for($i = 1; $i<=$numm; $i++){
					...
					for($j = 3; $j>0; $j--){
						if($j==$pos){
							?> <div class="col-md-4 portfolio-item">
								...
								<div class="newdesign1 text-center" style="height:"450px;">
								<h4>AD SPACE</h4>
								</div>
								</div> <?php
						}else{
				  ...
				  <div class="newdesign">
					  <div class="post">
					   <a href="usermyblog.php?bid=<?php echo $showblog["id"]; ?>">
					...
					<h3 class="post_heading">
						<a href="usermyblog.php?bid=<?php echo $showblog["id"]; ?>"><?php echo $showblog["title"]; ?></a>
					</h3>
					</div>
					
					<div class="post_des">
						<p style="word-wrap: break-word;"><?php echo limit_words($content,20); ?></p>
						<!------  ABOVE LINE OF CODE CAN BE USED IN POST PREVIEW -------!>
					</div>
					
					<div class="sender">
						<hr><strong>Posted By : &nbsp</strong><?php echo $rows["displayName"]; ?> 
						<div style="float:right;"><b>

						|| <a href="usermyblog.php?bid=<?php echo $showblog["id"]; ?>">READ MORE </a>||</b>
						</div>
						</div>
