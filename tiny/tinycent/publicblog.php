				...
				for($i = 1; $i<=$numm; $i++){
					...
					for($j = 3; $j>0; $j--){
						if($j==$pos){
							?> <div class="col-md-4 portfolio-item">
								...
								<div class="newdesign1 text-center">
								<h4>ADD SPACE</h4>
								</div>
								</div> <?php
						}else{
				  ...
				  <div class="newdesign">
					...
					<h3 class="post_heading">
						<a href="userblog.php?bid=<?php echo $showblog["id"]; ?>"><?php echo $showblog["title"]; ?></a>
					</h3>
					</div>
					...
					<div class="sender">
						...
						|| <a href="userblog.php?bid=<?php echo $showblog["id"]; ?>">READ MORE </a> ||
						</div>
						</div>
